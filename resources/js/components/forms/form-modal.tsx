...
export function FormModal({
    ...
    const ScrollArea = (
        <div className="relative min-h-0">
            <div
                ref={scrollRef}
                className="max-h-[min(52vh,28rem)] overflow-y-auto overscroll-contain px-1 py-3"
            >
                {children}
            </div>
    ...
    const bodyWrapperClass = 'relative flex h-fit flex-col overflow-hidden';
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent
                data-form-modal
                className={cn(
                    'flex h-fit max-h-[min(90vh,40rem)] flex-col gap-0 overflow-hidden border-border/60 bg-card p-0 shadow-xl shadow-foreground/8 ring-1 ring-border/50 dark:border-border/80 dark:shadow-black/25 dark:ring-border/60',
            ...
            >
                ...
                {onSubmit ? (
                    <form
                        ...
                        noValidate
                    >
                        <div className="overflow-hidden px-6 pt-1">{ScrollArea}</div>
                        {footer ? (
